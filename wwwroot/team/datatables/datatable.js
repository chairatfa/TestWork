...
(function(h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "หน้าเเรก", sLast: "หน้าสุดท้าย", sNext: "ถัดไป", sPrevious: "ก่อนหน้า" },
            sEmptyTable: " ",
            sInfo: "ตั้งเเต่ _START_ ถึง _END_ จาก _TOTAL_ ตาราง",
            sInfoEmpty: "ตั่งเเต่ 0 ถึง 0 จาก 0 ตาราง",
            sInfoFiltered: "(กรอง จาก _MAX_ ตาราง ทั้งหมด)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "เเสดง _MENU_ ตาราง",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: "ค้นหา:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "ไม่พบตารางที่ค้นหา"
        },
        oSearch: h.extend({},
            n.models.oSearch),
        sAjaxDataProp: "data",
